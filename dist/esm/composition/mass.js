 ...
 */
export class FfmChildEstimator {
 ...
 * @returns Fat Free Mass in kg
 */
export class FfmAdolescentEstimator {
 ...
 * @returns Fat Free Mass in kg
 */
export class FfmAdultLeanEstimator {
 ...
 * @returns Fat Free Mass in kg
 */
export class FfmAdultObeseEstimator {
    estimate({ gender, age, height, weight, resistance }) {
        if (gender === Gender.Female) {
 ...
 * @returns Fat Free Mass in kg
 */
export class FfmAdultAthleteEstimator {
