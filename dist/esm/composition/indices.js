 ...
 */
export class CorpulenceStrategy {
    name = "Corpulence";
    /**
     * @param metrics - The person's height (m) and weight (kg).
 ...
 */
export function bai(height, hipCircumference) {
 ...
 */
export function bsi(height, bmi, waistCircumference) {
 ...
 */
export function sbsi({ height, bsa, verticalTrunkCircumference, waistCircumference, }) {
 ...
 */
export function whr(waistCircumference, hipCircumference) {
 ...
 */
export function whtr(waistCircumference, height) {
