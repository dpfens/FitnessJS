...
*/
export function estimateMETs(kcal, kg, hours) {
...
*/
export function estimateKg(kcal, mets, hours) {
...
*/
export function estimateHours(kcal, mets, kg) {
    return kcal / (mets * kg);
}
export function toKCal(mets, weight) {
    return (mets * 3.5 * weight) / 200;
}
export function fromVO2(vO2) {
    return vO2 / 3.5;
}
export function karvonen(mets, intensity) {
    return intensity * (mets - 1) + 1;
}
export function target(vO2Max, intensity) {
