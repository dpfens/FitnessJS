...
*/
export function vO2Percentage(time) {
...
/*
  ...
  @returns {Number} pace in min/mile
*/
export function marathon(vO2Max) {
...
/*
  ...
  @returns {Number} pace in min/mile
*/
export function threshold(vO2Max) {
...
/*
  ...
  @returns {Number} pace in min/mile
*/
export function interval(vO2Max) {
