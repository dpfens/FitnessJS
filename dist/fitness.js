...
Date.prototype.delta = function (unit, date) {
    ...
    var difference = Math.abs(this.getTime() - date.getTime());
    return difference / units[unit];
};
define("conversion/system", ["require", "exports"], function (require, exports) {
    "use strict";
    ...
    var UnitConverter = (function () {
        ...
        UnitConverter.addUnit = function (baseUnit, prefixed, unitMultiplier) {
    ...
    var base;
    for (var _i = 0, siUnits_1 = siUnits; _i < siUnits_1.length; _i++) {
        base = siUnits_1[_i];
...
define("conversion/swain", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
    ...
    exports.percentVO2Max = percentVO2Max;
    ...
    exports.percentHrMax = percentHrMax;
});
define("conversion/temperature", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
...
define("conversion/conversion", ["require", "exports", "conversion/system", "conversion/swain", "conversion/temperature"], function (require, exports, system, swain, temperature) {
    "use strict";
    exports.__esModule = true;
...
define("mets", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
    var MET = (function () {
    ...
    function byCode(code) {
        for (var _i = 0, mets_1 = exports.mets; _i < mets_1.length; _i++) {
            var entry = mets_1[_i];
            if (entry.code === code)
                return entry;
        }
...
define("cardiovascular/cardiac", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
    ...
    exports.TMS = TMS;
    function meanArterialPressure(diastolicBp, systolicBp) {
...
define("enums", ["require", "exports"], function (require, exports) {
    ...
    })(PAL = exports.PAL || (exports.PAL = {}));
});
define("cardiovascular/energy", ["require", "exports", "enums"], function (require, exports, enums_1) {
    "use strict";
    exports.__esModule = true;
    ...
    exports.BMREstimator = BMREstimator;
    var HB = (function (_super) {
        ...
        HB.prototype.predict = function (dob, weight, height) {
            var age = dob.delta("years");
            if (this.gender === enums_1.Gender.Female) {
    ...
    var ChildTEE = (function (_super) {
        ...
        ChildTEE.prototype.predict = function (dob, weight, height) {
            var age = dob.delta("years");
            if (this.pal === enums_1.PAL.Sedentary && this.gender === enums_1.Gender.Male) {
                return 88.5 - (61.9 * age) + 1 * ((26.7 * weight) + (903 * height));
            }
            else if (this.pal === enums_1.PAL.Sedentary && this.gender === enums_1.Gender.Female) {
                return 135.3 - (30.8 * age) + 1 * ((10 * weight) + (934 * height));
            }
            else if (this.pal === enums_1.PAL.Low && this.gender === enums_1.Gender.Male) {
                return 88.5 - (61.9 * age) + 1.13 * ((26.7 * weight) + (903 * height));
            }
            else if (this.pal === enums_1.PAL.Low && this.gender === enums_1.Gender.Female) {
                return 135.3 - (30.8 * age) + 1.16 * ((10 * weight) + (934 * height));
            }
            else if (this.pal === enums_1.PAL.Active && this.gender === enums_1.Gender.Male) {
                return 88.5 - (61.9 * age) + 1.26 * ((26.7 * weight) + (903 * height));
            }
            else if (this.pal === enums_1.PAL.Active && this.gender === enums_1.Gender.Female) {
                return 135.3 - (30.8 * age) + 1.31 * ((10 * weight) + (934 * height));
            }
            else if (this.pal === enums_1.PAL.VeryActive && this.gender === enums_1.Gender.Male) {
                return 88.5 - (61.9 * age) + 1.42 * ((26.7 * weight) + (903 * height));
            }
            else if (this.pal === enums_1.PAL.VeryActive && this.gender === enums_1.Gender.Female) {
    ...
    var Terrain = (function () {
        ...
        Terrain.prototype.pandolf = function (terrain, slope) {
            var totalWeight = this.weight + this.load;
        ...
        Terrain.prototype.santee = function (terrain, slope) {
            var totalWeight = this.weight + this.load;
            var kineticEnergy = this.speed * slope;
            var speedSquared = Math.pow(this.speed, 2);
            var part1 = 1.5 * this.weight + 2 * Math.pow(this.load / this.weight, 2);
            var part2 = terrain * totalWeight * (1.5 * speedSquared + 0.35 * kineticEnergy);
            var part31 = (kineticEnergy * totalWeight) / 3.5;
            var part32 = (totalWeight * Math.pow(slope + 6, 2)) / this.weight;
            var part33 = 25 - speedSquared;
...
define("cardiovascular/respiration", ["require", "exports", "enums"], function (require, exports, enums_2) {
    "use strict";
    exports.__esModule = true;
    var ResidualVolume = (function () {
        ...
        ResidualVolume.prototype.berglund = function () {
            var age = this.dob.delta("years");
            var heightCm = this.height * 100;
            if (this.gender === enums_2.Gender.Female) {
...
define("cardiovascular/cardiovascular", ["require", "exports", "cardiovascular/cardiac", "cardiovascular/energy", "cardiovascular/respiration"], function (require, exports, cardiac, energy, respiration) {
    "use strict";
    exports.__esModule = true;
    exports.cardiac = cardiac;
    exports.energy = energy;
    exports.respiration = respiration;
});
define("composition/density", ["require", "exports", "enums"], function (require, exports, enums_3) {
    "use strict";
    exports.__esModule = true;
    var Density = (function () {
        function Density(gender, dob, height, weight) {
            this.dbAtRV = function (bd) {
                if (this.gender === enums_3.Gender.Female) {
...
define("composition/hydration", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
...
define("composition/fat", ["require", "exports", "enums"], function (require, exports, enums_4) {
    "use strict";
    exports.__esModule = true;
    var Fat = (function () {
        function Fat() {
        ...
        Fat.childBmi = function (gender, dob, weight, height) {
            ...
            if (this.gender === enums_4.Gender.Female) {
        ...
        Fat.adultBmi = function (gender, dob, weight, height) {
            ...
            if (gender === enums_4.Gender.Female) {
...
define("composition/index", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
    var Index = (function () {
        ...
        Index.prototype.bmi_prime = function (upperLimit) {
            if (upperLimit === void 0) { upperLimit = 25.9; }
            return this.bmi() / upperLimit;
        };
        Index.prototype.bsi = function (waistCircumference) {
        ...
        Index.prototype.sbsi = function (bsa, verticalTrunkCircumference, waistCircumference) {
...
define("composition/mass", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
    var Mass = (function () {
...
define("composition/stature", ["require", "exports", "enums"], function (require, exports, enums_5) {
    "use strict";
    exports.__esModule = true;
    var Stature = (function () {
        ...
        Stature.prototype.strideLength = function () {
            var heightCm = this.height * 100;
            var strideLength = 0;
            if (this.gender === enums_5.Gender.Female) {
...
define("composition/surfacearea", ["require", "exports", "enums"], function (require, exports, enums_6) {
    "use strict";
    exports.__esModule = true;
    var SurfaceArea = (function () {
        function SurfaceArea(gender, dob, height, weight) {
            ...
            this.schlich = function () {
                var heightCm = this.height * 100;
                if (this.gender === enums_6.Gender.Female) {
...
define("composition/ideal", ["require", "exports", "enums"], function (require, exports, enums_7) {
    "use strict";
    exports.__esModule = true;
    ...
    var Ideal = (function () {
        function Ideal(gender, dob, height, weight) {
            this.hamwi = function () {
                ...
                if (this.gender === enums_7.Gender.Female) {
...
define("composition/composition", ["require", "exports", "composition/density", "composition/hydration", "composition/fat", "composition/index", "composition/mass", "composition/stature", "composition/surfacearea", "composition/ideal"], function (require, exports, density, hydration, fat, index, mass, stature, surfaceArea, ideal) {
    "use strict";
    exports.__esModule = true;
    exports.density = density;
...
define("strength/strength", ["require", "exports", "enums"], function (require, exports, enums_8) {
    "use strict";
    exports.__esModule = true;
    var Compare = (function () {
        ...
        Compare.prototype.siffWeight = function () {
            ...
            var b = 146230;
            var c = 1.605;
            if (this.gender === enums_8.Gender.Female) {
                a = 943.063;
                b = 0.05142;
                c = 257.314;
    ...
    var Jump = (function () {
        ...
        Jump.prototype.bosco = function (duration, jumpCount, totalFlightTime) {
    ...
    exports.RMEstimator = RMEstimator;
...
define("models/aerobic", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
    ...
    var VV = (function () {
        ...
        VV.prototype.time = function (mileage, d2) {
            ...
            var riegelVelocity = this.riegel_velocity(d2);
            var velocity = 0.16018617 + (0.83076202 * riegelVelocity) + (0.6423826 * (mileage / 10));
        ...
        VV.prototype.time2 = function (mileage, d2, t2, distance) {
            ...
            var adjTimerR1 = this.adj_timer(this.d1, this.t1);
            var adjTimerR2 = this.adj_timer(d2, t2);
            var kR2R1 = Math.log(adjTimerR2 / adjTimerR1) / Math.log(d2 / this.d1);
            var kMarathon = 1.4510756 + (-0.23797948 * kR2R1) + (-0.01410023 * (mileage / 10));
            var seconds = (adjTimerR2 * Math.pow(distance / d2, kMarathon));
            return seconds;
        };
        ...
        VV.prototype.riegel_velocity = function (distance) {
            var adjTimer = this.adj_timer(this.d1, this.t1);
...
define("sport/running/adjustment", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
...
define("sport/running/pace", ["require", "exports", "conversion/swain"], function (require, exports, swain_1) {
    "use strict";
    exports.__esModule = true;
    ...
    function hrSpeed(percentHR, vO2Max) {
        var vO2MaxPercent = swain_1.percentVO2Max(percentHR);
...
define("sport/running/grading", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
    ...
    exports.RunningAgeGrade = RunningAgeGrade;
});
define("sport/running/jackdaniels", ["require", "exports", "sport/running/pace"], function (require, exports, pace_1) {
    "use strict";
    exports.__esModule = true;
    ...
    exports.vO2Percentage = vO2Percentage;
    function easy(vO2Max) {
        return [pace_1.hrPace(0.6, vO2Max), pace_1.hrPace(0.79, vO2Max)];
    }
    exports.easy = easy;
    function marathon(vO2Max) {
        return [pace_1.hrPace(0.8, vO2Max), pace_1.hrPace(0.85, vO2Max)];
    }
    exports.marathon = marathon;
    function threshold(vO2Max) {
        return [pace_1.hrPace(0.82, vO2Max), pace_1.hrPace(0.88, vO2Max)];
    }
    exports.threshold = threshold;
    function interval(vO2Max) {
        return [pace_1.hrPace(0.97, vO2Max), pace_1.hrPace(1, vO2Max)];
    }
    exports.interval = interval;
});
define("sport/sport", ["require", "exports", "sport/running/adjustment", "sport/running/pace", "sport/running/grading", "sport/running/jackdaniels"], function (require, exports, adjustment, pace, grading, jackDaniels) {
    "use strict";
    exports.__esModule = true;
    var running = {
