...
exports.RunningAgeGrade = exports.MAX_AGE = exports.MIN_AGE = void 0;
const age_grade_table_js_1 = require("./age-grade-table.js");
exports.MIN_AGE = 5;
exports.MAX_AGE = 100;
class RunningAgeGrade {
    ...
    static table = age_grade_table_js_1.ageGradeTable;
    gender;
    age;
    ...
    normalize(event, time) {
        ...
        const conversionFactor = eventData.conversions[this.age - exports.MIN_AGE];
    ...
    static isAgeInRange(age) {
        return Number.isFinite(age) && age >= exports.MIN_AGE && age <= exports.MAX_AGE;
    }
