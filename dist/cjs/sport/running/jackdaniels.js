...
function easy(vO2Max) {
    return [(0, pace_js_1.hrPace)(0.6, vO2Max), (0, pace_js_1.hrPace)(0.79, vO2Max)];
}
/*
  Marathon (M) pace
...
function marathon(vO2Max) {
    return [(0, pace_js_1.hrPace)(0.8, vO2Max), (0, pace_js_1.hrPace)(0.85, vO2Max)];
}
/*
  Threshold (T) pace
...
function threshold(vO2Max) {
    return [(0, pace_js_1.hrPace)(0.82, vO2Max), (0, pace_js_1.hrPace)(0.88, vO2Max)];
}
/*
  Interval (I) pace
...
function interval(vO2Max) {
    return [(0, pace_js_1.hrPace)(0.97, vO2Max), (0, pace_js_1.hrPace)(1, vO2Max)];
}
//# sourceMappingURL=jackdaniels.js.map