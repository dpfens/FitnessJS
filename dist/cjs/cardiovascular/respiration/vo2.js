...
exports.EnergyCostEstimation = exports.VO2MaxEstimation = void 0;
exports.vo2Reserve = vo2Reserve;
exports.vo2Target = vo2Target;
...
class VO2MaxEstimation {
    ...
    georgeTreadmill(speed, hr) {
        const genderTerm = this.gender === enums_js_1.Gender.Female ? 0 : 7.062;
     ...
     */
    georgeRW(time) {
        const genderTerm = this.gender === enums_js_1.Gender.Female ? 0 : 3.716;
    ...
    georgeSteady(time, hr) {
        const genderTerm = this.gender === enums_js_1.Gender.Female ? 0 : 8.344;
     ...
     */
    kline(time, hrPeak) {
        const genderTerm = this.gender === enums_js_1.Gender.Female ? 0 : 6.315;
        return (132.853 -
            0.0769 * this.weight -
            0.3877 * this.age +
            genderTerm -
     ...
     */
    larsen(time, hr) {
        const genderTerm = this.gender === enums_js_1.Gender.Female ? 0 : 7.3;
    ...
    ebbelingTreadmill(speed, hr) {
        const genderTerm = this.gender === enums_js_1.Gender.Female ? 0 : 5.48;
        return (15.1 +
            21.8 * speed -
            0.327 * hr -
            0.263 * this.age +
    ...
    treadmillSubmaxSingleStage(sm1, hr1, hrmax) {
        const restingHR = this.gender === enums_js_1.Gender.Female ? 72 : 61;
...
exports.VO2MaxEstimation = VO2MaxEstimation;
/**
...
exports.EnergyCostEstimation = EnergyCostEstimation;
/**
