...
exports.RM = exports.estimators = exports.Jump = exports.Compare = void 0;
exports.applicableEstimators = applicableEstimators;
...
exports.estimators = [
    ...
    formula({
        ...
        isValid: (gender, age, reps) => gender === enums_js_1.Gender.Female && reps >= 5 && reps <= 10 && age > 17 && age < 25,
    }),
    /**
     * Baechle method.
...
function applicableEstimators(gender, age, reps) {
    return exports.estimators.filter((e) => e.isValid(gender, age, reps));
}
/** Look up a formula by name (typed, autocompletes against FormulaName). */
function getEstimator(name) {
    const found = exports.estimators.find((e) => e.name === name);
    if (!found)
