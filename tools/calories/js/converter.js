    ...
    var app = new Vue({
        ...
        methods: {
            addPerson: function(person, reset) {
                ...
                self.showSnackbar(addedPerson.name + ' Added.', handler, snackbarOptions);
            ...
            setUnit: function(person, type, unit, current) {
                ...
                if (currentValue && oldUnits) {
                    person[type].value = new Fit.conversion.UnitConverter(currentValue, oldUnits.value).to(unit.value).val();
                }
                this.updateURL();
            },
            mSJ: function(person) {
