...
export class UnitConverter {
  private static unitTable: Record<string, UnitEntry> = {};
  ...
  static addUnit(base: string, prefixed: string, multiplier: number, overwrite = false): void {
...
const siUnits: string[] = ['g', 'b', 'm', 'A', 'cd', 'mol', 'K', 'are', 'Pa', 'J', 'W'];
