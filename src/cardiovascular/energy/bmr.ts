 ...
 */
export abstract class BaseBMREstimator implements BMREstimator {
 ...
 */
export class HB extends BaseBMREstimator {
  /**
 ...
 * @extends BaseBMREstimator
 */
export class RevisedHB extends BaseBMREstimator {
  /**
 ...
 * @extends BaseBMREstimator
 */
export class MSJ extends BaseBMREstimator {
  /**
