 ...
 */
export class PandolfStrategy implements TerrainEnergyExpenditureEstimator {
  /**
   * @param params Parameters required for the calculation
   * @returns Energy expenditure in watts
   *
 ...
 */
export class SanteeStrategy implements TerrainEnergyExpenditureEstimator {
  /**
   * @param params Parameters required for the calculation
   * @returns Energy expenditure in watts
   *
...
export class Terrain {
  private strategy: TerrainEnergyExpenditureEstimator;
