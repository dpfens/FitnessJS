 ...
 * @class TEEEstimator
 */
export abstract class TEEEstimator {
...
/**
 * Coefficients for a single gender/PAL combination, following the form:
 *
 * `TEE = base - ageCoef * age + palFactor * (weightCoef * weight + heightCoef * height)`
 */
interface TEECoefficients {
    /** Constant term (kcal/day) */
    base: number;
    /** Coefficient applied to age (years) */
    ageCoef: number;
    /** Physical activity multiplier applied to the weight/height term */
    palFactor: number;
    /** Coefficient applied to weight (kg) */
    weightCoef: number;
    /** Coefficient applied to height (m) */
    heightCoef: number;
}
 ...
 */
const CHILD_TEE_COEFFICIENTS: Record<Gender, Record<PAL, TEECoefficients>> = {
    [Gender.Male]: {
        [PAL.Sedentary]:  { base: 88.5,  ageCoef: 61.9, palFactor: 1.00, weightCoef: 26.7, heightCoef: 903 },
        [PAL.Low]:        { base: 88.5,  ageCoef: 61.9, palFactor: 1.13, weightCoef: 26.7, heightCoef: 903 },
        [PAL.Active]:     { base: 88.5,  ageCoef: 61.9, palFactor: 1.26, weightCoef: 26.7, heightCoef: 903 },
        [PAL.VeryActive]: { base: 88.5,  ageCoef: 61.9, palFactor: 1.42, weightCoef: 26.7, heightCoef: 903 },
    },
    [Gender.Female]: {
        [PAL.Sedentary]:  { base: 135.3, ageCoef: 30.8, palFactor: 1.00, weightCoef: 10, heightCoef: 934 },
        [PAL.Low]:        { base: 135.3, ageCoef: 30.8, palFactor: 1.16, weightCoef: 10, heightCoef: 934 },
        [PAL.Active]:     { base: 135.3, ageCoef: 30.8, palFactor: 1.31, weightCoef: 10, heightCoef: 934 },
        [PAL.VeryActive]: { base: 135.3, ageCoef: 30.8, palFactor: 1.56, weightCoef: 10, heightCoef: 934 },
    },
};
...
export class ChildTEE extends TEEEstimator {
    ...
    predict({ age, weight, height }: TEEPredictParams): number {
        ...
        if (!coeffs) {
            throw new Error(
                `No ChildTEE coefficients defined for gender=${this.gender}, pal=${this.pal}`
            );
        }
 ...
 */
const ADULT_TEE_COEFFICIENTS: Record<Gender, Record<PAL, TEECoefficients>> = {
    [Gender.Male]: {
        [PAL.Sedentary]:  { base: 662, ageCoef: 9.53, palFactor: 1.00, weightCoef: 15.91, heightCoef: 539.6 },
        [PAL.Low]:        { base: 662, ageCoef: 9.53, palFactor: 1.11, weightCoef: 15.91, heightCoef: 539.6 },
        [PAL.Active]:     { base: 662, ageCoef: 9.53, palFactor: 1.25, weightCoef: 15.91, heightCoef: 539.6 },
        [PAL.VeryActive]: { base: 662, ageCoef: 9.53, palFactor: 1.48, weightCoef: 15.91, heightCoef: 539.6 },
    },
    [Gender.Female]: {
        [PAL.Sedentary]:  { base: 354, ageCoef: 6.91, palFactor: 1.00, weightCoef: 9.36, heightCoef: 726 },
        [PAL.Low]:        { base: 354, ageCoef: 6.91, palFactor: 1.12, weightCoef: 9.36, heightCoef: 726 },
        [PAL.Active]:     { base: 354, ageCoef: 6.91, palFactor: 1.27, weightCoef: 9.36, heightCoef: 726 },
        [PAL.VeryActive]: { base: 354, ageCoef: 6.91, palFactor: 1.45, weightCoef: 9.36, heightCoef: 726 },
    },
};
...
export class AdultTEE extends TEEEstimator {
    ...
    predict({ age, weight, height }: TEEPredictParams): number {
        ...
        if (!coeffs) {
            throw new Error(
                `No AdultTEE coefficients defined for gender=${this.gender}, pal=${this.pal}`
            );
        }
        const { base, ageCoef, palFactor, weightCoef, heightCoef } = coeffs;
        return base - ageCoef * age + palFactor * (weightCoef * weight + heightCoef * height);
