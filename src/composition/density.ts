...
export class Density {
    ...
    */
    public dbAtRV = function(bd: number): number {
    ...
    */
    public skinfoldDbChild = function(sum2SKF: number): number {
      if (this.gender === Gender.Female) {
    ...
    @return {Number} %body density
    */
    public skinfoldDbBlackHispanicFemale = function(sum7SKF: number): number {
    ...
    @return {Number} %body density
    */
    public skinfoldDbWhiteMale = function(sum3SKF: number): number {
        const age = this.dob.delta("years");
    ...
    @return {Number} %body density
    */
    public skinfoldDbWhiteFemaleAnorexic = function(sum3SKF: number): number {
        const age = this.dob.delta("years");
    ...
    */
    public skinfoldDbAthlete = function(sum: number): number {
        const age = this.dob.delta("years");
        if (this.gender === Gender.Female) {
    ...
    @returns {Number} body density in g / cc
    */
    public skinfoldDbCollegiateAthleteBlack = function(sum): number {
        if (this.gender === Gender.Female) {
    ...
    @returns {Number} body density in g / cc
    */
    public skinfoldDbCollegiateAthleteWhite = function(sum3SKF: number): number {
        if (this.gender === Gender.Female) {
    ...
    */
    public bodyVol = function(uww: number, rv: number, gv: number): number {
