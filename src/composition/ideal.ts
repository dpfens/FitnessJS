...
export interface IdealWeightParams {
  gender: Gender;
  height: number; // in inches, unless noted otherwise per Estimator
}
 ...
 * G. Hamwi (1964)
 */
export class HamwiEstimator implements IdealWeightEstimator {
  /**
 ...
 * B. Devine (1974)
 */
export class DevineEstimator implements IdealWeightEstimator {
  /**
   * @param height - height in inches
   * @returns ideal weight in kg
   */
 ...
 */
export class RobinsonEstimator implements IdealWeightEstimator {
  /**
   * @param height - height in inches
   * @returns ideal weight in kg
   */
 ...
 * D. Miller (1983)
 */
export class MillerEstimator implements IdealWeightEstimator {
  /**
   * @param height - height in inches
   * @returns ideal weight in kg
   */
 ...
 */
export class LemmensEstimator implements IdealWeightEstimator {
  /**
 ...
 */
export class Ideal {
  private Estimator: IdealWeightEstimator;
  private params: IdealWeightParams;
 ...
 */
export function willoughbyWeight(height: number): number {
 ...
 */
export function willoughbyWaist(height: number): number {
  const heightInches = height * 39.3701;
