...
export class Stature {
    ...
    */
    public statureUniversal = function(): number {
    ...
    @param {Number} femurLength in cm
    */
    public statureAmericanWhite = function(femurLength: number): number {
    ...
    @param {Number} femurLength in cm
    */
    public statureAmericanBlack = function(femurLength: number): number {
         if (this.gender === this.Gender.Female) {
