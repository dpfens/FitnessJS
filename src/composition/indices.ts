...
/* ------------------------------------------------------------------ */
/* Strategy pattern: interchangeable height/weight "mass index" family */
/* ------------------------------------------------------------------ */
 ...
 */
export class BmiStrategy implements MassIndexStrategy {
  readonly name = "BMI";
 ...
 */
export class BmiPrimeStrategy implements MassIndexStrategy {
   ...
   */
  constructor(private readonly upperLimit: number = 25.9) {}
 ...
 */
export class CorpulenceStrategy implements MassIndexStrategy {
 ...
 * ```
 */
export class MassIndexCalculator {
  /**
   ...
   */
  constructor(private readonly metrics: BodyMetrics) {}
 ...
 */
export function bai(height: number, hipCircumference: number): number {
 ...
 */
export function bsi(height: number, bmi: number, waistCircumference: number): number {
 ...
 */
export function sbsi({
  height,
  bsa,
  verticalTrunkCircumference,
  waistCircumference,
}: SbsiParams): number {
  return (
    (Math.pow(height, 7 / 4) * Math.pow(waistCircumference, 5 / 6)) /
 ...
 */
export function whr(waistCircumference: number, hipCircumference: number): number {
 ...
 */
export function whtr(waistCircumference: number, height: number): number {
