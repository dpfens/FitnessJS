...
export class Mass {
    ...
    */
    public ffmChild = function(resistance: number, reactance: number): number {
    ...
    @returns {Number} Fat Free Mass in kg
    */
    public ffmAdolescent = function(resistance: number, reactance: number): number {
        const heightCm: number = this.height * 100;
    ...
    @returns {Number} Fat Free Mass in kg
    */
    public ffmAdultLean = function(resistance: number, reactance: number): number {
    ...
    @returns {Number} Fat Free Mass in kg
    */
    public ffmAdultObese = function(resistance: number, reactance: number): number {
          const age: number = this.dob.delta("years");
          const heightCm: number = this.height * 100;
        /*
        American Indian, black, Hispanic, and White Women
    ...
    @returns {Number} Fat Free Mass in kg
    */
    public ffmAdultAthlete = function(resistance: number, reactance: number): number {
        const heightCm: number = this.height * 100;
        /*
